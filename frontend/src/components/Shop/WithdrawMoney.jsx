...
const WithdrawMoney = () => {
  ...
  const withdrawHandler = async () => {
    if (withdrawAmount < 500000 || withdrawAmount > availableBalance) {
  ...
  return (
    <div className="w-full h-[90vh] p-8">
      ...
      <h5 className="text-[20px] pb-4">
          Available Balance: {new Intl.NumberFormat('de-DE').format(availableBalance)}đ
        </h5>
        <div
          className={`${styles.button} text-white !h-[42px] !rounded`}
          onClick={() => (availableBalance < 500000 ? error() : setOpen(true))}
        >
          Withdraw
        </div>
      </div>
              ...
              <>
                ...
                {seller && seller?.withdrawMethod ? (
                  <div>
                    ...
                    <br />
                    <h4>Available Balance: {new Intl.NumberFormat('de-DE').format(availableBalance)}đ</h4>
                    <br />
